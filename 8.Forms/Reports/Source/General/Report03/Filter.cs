...
namespace Sepehr.Forms.Reports.General.Report03
{
    /// <summary>
    ...
    public partial class frmFilter : Form
    {
        ...
        private void BGWorker_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (!_CalcReportRowCount)
            {
                ...
                {
                    PersianDate PDate = Convert.ToDateTime(_ReportDataTable.Rows[i]["RefDate"]).ToPersianDate();
        ...
        private Boolean GenerateReportString()
        {
            ...
            ReportSelectString.Append("SELECT [TblPatients].[PatientID], " +
                ...
                "[ImagingSystem].[Accounting].[FK_CalcRefServicesPayable]([TblRefList].[ID]) AS [RefServicesPayable] , " +
                "[ImagingSystem].[Accounting].[FK_CalcSumDiscount]([TblRefList].[ID]) AS [SumDiscounts] , " +
                "[ImagingSystem].[Accounting].[FK_CalcSumCost]([TblRefList].[ID]) AS [SumCosts] , " +
                ...
                "(CASE WHEN [TblRefList].[RemainValue] > 0 THEN 'بدهكار' ELSE 'طلبكار' END) AS [RemainType] , " +
            ...
            if (!_CalcReportRowCount)
                ReportSelectWhereString.Append(" ORDER BY [TblRefList].[RegisterDate];");
            #endregion
