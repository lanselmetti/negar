...
namespace Sepehr.Forms.Reports.General.Report13
{
    ...
    public partial class frmFilter : Form
    {
        ...
        private void BGWorker_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            {
                PersianDate PDate =
                    PersianDateConverter.ToPersianDate(Convert.ToDateTime(_ReportDataTable.Rows[i]["RefDate"]));
                _ReportDataTable.Rows[i]["RefDateFa"] = PDate.Year + "/" + PDate.Month + "/" + PDate.Day;
                PDate = PersianDateConverter.ToPersianDate(Convert.ToDateTime(_ReportDataTable.Rows[i]["OccuredDate"]));
        ...
        {
            #region Make Report
            Report13 MyReport = new Report13();
            PersianDate DateVal1 = PersianDateConverter.ToPersianDate(new DateTime(
                ...
                FromTimeCD.Value.Minute, FromTimeCD.Value.Second));
            ...
            PersianDate DateVal2 = PersianDateConverter.ToPersianDate(new DateTime(
                ...
                ToTimeCD.Value.Minute, ToTimeCD.Value.Second));
        ...
        private Boolean GenerateReportString()
        {
            ...
            ReportSelectWhereString.Append(" ORDER BY [TblRefCAndD].[CostIXOrDiscountIX] , [TblRefCAndD].[Date];");
            #endregion
