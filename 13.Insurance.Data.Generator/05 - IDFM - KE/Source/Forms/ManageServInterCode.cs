...
namespace Sepehr.Forms
{
    ...
    internal partial class frmManageServInterCode : Office2007Form
    {
        ...
        /// <summary>
        /// كلاس لایه اطلاعات برای ارتباط با بانك اطلاعاتی
        /// </summary>
        ...
        {
            try { dgvData.DataSource = _DbClassIS.SP_SelectServicesList().Where(Data => Data.IsActive).OrderBy(Data => Convert.ToInt32(Data.Code)).ToList(); }
            #region Catch
            catch (Exception Ex)
            {
