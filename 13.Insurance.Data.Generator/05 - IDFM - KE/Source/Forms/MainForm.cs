...
namespace Sepehr.Forms
{
    ...
    internal partial class frmMainForm : Form
    {
        ...
        private Boolean FillBaseData()
        {
            ...
            _InsType.Add(70, "فرانشیز 30%");
            _InsType.Add(80, "فرانشیز 20%");
            _InsType.Add(90, "فرانشیز 10%");
            _InsType.Add(100, "نسخ رایگان");
            ...
            try
            {
                ...
                List<SP_SelectInsFullDataResult> InsData = _DbClassIS.SP_SelectInsFullData().
                ...
                List<SP_SelectCategoriesResult> Categories = _DbClassIS.SP_SelectCategories().
                    Where(Data => Data.ID != null).ToList();
        ...
        private void GenerateInsDataFile()
        {
            ...
            String FilePath = txtSavePath.Text + "\\NOS1.Txt";
            try
            {
            ...
            for (Int16 RefRowIndex = 0; RefRowIndex < dgvRefData.Rows.Count; RefRowIndex++)
            {
                ...
                #region PT - Ins Type - 70 , 80 , 90 , 100
                // نوع بیمه - مقدار ثابت
                ...
                #region NN - Second Part Of Ins1Num2
                // Note: این تگ در تاریخ 89.09.14 حذف گردید - پورنجاتی
                // شماره نسخه
                GeneratedDataString.Append("<NN>");
                //if (dgvRefData[ColRefIns1Num2.Index, RefRowIndex].Value != DBNull.Value)
                //{
                //    String InsNumber = dgvRefData[ColRefIns1Num2.Index, RefRowIndex].Value.ToString();
                //    for (Int16 i = 0; i < InsNumber.Count(); i++)
                //    {
                //        if (InsNumber[i].ToString() != "/") continue;
                //        String w = InsNumber.Substring(InsNumber.IndexOf("/") + 1, InsNumber.Length - InsNumber.IndexOf("/") - 1);
                //        GeneratedDataString.Append(w);
                //    }
                //}
                GeneratedDataString.Append("</NN>");
                #endregion
                ...
                #region NP - Ref Phys Type ID
                // كد پزشك
                GeneratedDataString.Append("<NP>");
                if (dgvRefData[ColRefPhysTypeID.Index, RefRowIndex].Value != null &&
                    dgvRefData[ColRefPhysTypeID.Index, RefRowIndex].Value != DBNull.Value)
                    GeneratedDataString.Append(dgvRefData[ColRefPhysTypeID.Index, RefRowIndex].Value.ToString());
                GeneratedDataString.Append("</NP>");
                #endregion
                ...
                //ToDo: نمی دانم شماره سریال ارجاع چیست
                //GeneratedDataString.Append("</RN>");
                #endregion
