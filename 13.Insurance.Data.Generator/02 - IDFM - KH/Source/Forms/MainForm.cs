...
namespace Sepehr.Forms
{
    ...
    internal partial class frmMainForm : Form
    {
        ...
        private void Form_Shown(object sender, EventArgs e)
        {
            ...
            PersianDate CurrentPersianDate = PersianDateConverter.ToPersianDate(DateTime.Now);
        ...
        private void BGWorkerSearchData_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            catch (Exception Ex)
            {
                ...
                LogManager.SaveLogEntry("Sepehr", "IDFM - KH", Ex.Message + "\n" + Ex.StackTrace, EventLogEntryType.Error);
                e.Cancel = true;
                return;
            }
        ...
        {
            if (e.ColumnIndex != ColFileName.Index || e.FormattedValue == null)
                return;
        ...
        private Boolean FillBaseData()
        {
            ...
            _ServiceType.Add(1, "ویزیت سرپایی");
            ...
            _ServiceType.Add(11, "آنژیو گرافی");
        ...
        private void GenerateInsDataFile()
        {
            for (Int32 InsRowIndex = 0; InsRowIndex < dgvIns.Rows.Count; InsRowIndex++)
            {
                ...
                String FilePath = txtSavePath.Text + "\\NOS" + dgvIns[ColFileName.Index, InsRowIndex].Value + ".Txt";
                try
                {
                ...
                #region <RC> - Ref Count
                // جستجو در بین مراجعاتی كه برای صندوق انتخاب شده هستند
                Int32 RC = 0;
                foreach (DataGridViewRow row in dgvRefData.Rows)
                    if (Convert.ToInt16(row.Cells[ColRefIns1ID.Index].Value) ==
                        Convert.ToInt16(dgvIns[ColInsID.Index, InsRowIndex].Value)) RC++;
                // تعداد نسخه - <RC>
                ...
                for (Int16 RefRowIndex = 0; RefRowIndex < dgvRefData.Rows.Count; RefRowIndex++)
                {
                    ...
                    GeneratedDataString.Append(RefIndex);
                    GeneratedDataString.Append("</SQ>");
                    #endregion
                    ...
                    #region PT - Ins Type - Fix: 105
                    // نوع بیمه - مقدار ثابت
                    GeneratedDataString.Append("<PT>");
                    GeneratedDataString.Append(105);
                    GeneratedDataString.Append("</PT>");
                    #endregion
                    ...
                    GeneratedDataString.AppendLine("</SN>");
                    #endregion
                    ...
                    for (Int16 RefServiceIndex = 0; RefServiceIndex < CurrentRefServicesList.Length; RefServiceIndex++)
                    {
                        ...
                        if (Convert.ToInt16(CurrentRefServicesList[RefServiceIndex][8]) == 13) x = "S=1";
