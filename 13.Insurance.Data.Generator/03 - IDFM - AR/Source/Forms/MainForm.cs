...
namespace Sepehr.Forms
{
    ...
    internal partial class frmMainForm : Form
    {
        ...
        private Boolean FillBaseData()
        {
            ...
            _ServiceType.Add(2, "دارو");
            _ServiceType.Add(3, "آزمایش");
            _ServiceType.Add(4, "پرتوپزشكی");
            _ServiceType.Add(5, "سی تی اسپیرال");
        ...
        private void GenerateInsDataFile()
        {
            ...
            for (Int32 InsRowIndex = 0; InsRowIndex < dgvIns.Rows.Count; InsRowIndex++)
            {
                ...
                String FilePath = txtSavePath.Text + "\\Rad" + dgvIns[ColFileName.Index, InsRowIndex].Value + ".Txt";
                try
                {
                ...
                #region <MC> - Unit Head Phys
                //شماره نظام پزشكی مسئول فنی مركز - <MC>
                GeneratedDataString.Append("<MC>");
                GeneratedDataString.Append(txtHeadPhys.Text.Trim());
                GeneratedDataString.AppendLine("</MC>");
                #endregion
                ...
                for (Int16 RefRowIndex = 0; RefRowIndex < dgvRefData.Rows.Count; RefRowIndex++)
                {
                    ...
                    for (Int16 RefServiceIndex = 0; RefServiceIndex < CurrentRefServicesList.Length; RefServiceIndex++)
                    {
                        ...
                        String MNData = String.Empty;
                        if (Convert.ToInt16(CurrentRefServicesList[RefServiceIndex][8]) == 5) MNData = "S=1";
                        //else MNData = CurrentRefServicesList[RefServiceIndex][2].ToString();
                        GeneratedDataString.Append(MNData);
                        GeneratedDataString.Append("</MN>");
                        #endregion
