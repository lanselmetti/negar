...
namespace Sepehr.Forms
{
    ...
    internal partial class frmMainForm : Form
    {
        ...
        #region SqlConnection _PMSConnectionString
        /// <summary>
        /// كانكشن برای ارتباط با اس كیو ال
        /// </summary>
        private readonly SqlConnection _PMSConnectionString;
        #endregion
        ...
        #region Dictionary<Int32, String> _SelectedService
        /// <summary>
        /// كلید طبقه بندی های خدمات انتخاب شده و كلید آنها از نظر بیمه
        /// </summary>
        private Dictionary<Int32, String> _SelectedService;
        #endregion
        ...
        #region Dictionary<Int16, String> _ServiceType
        /// <summary>
        /// نوع های خدمات
        /// </summary>
        private Dictionary<Int16, String> _ServiceType;
        ...
        public frmMainForm()
        {
            ...
            _PMSConnectionString = new SqlConnection(CSManager.GetConnectionString("PatientsSystem"));
        ...
        private void Form_Shown(object sender, EventArgs e)
        {
            ...
            if (!FillBaseData()) { FormClosing -= Form_Closing; Close(); return; }
        ...
        {
            #region User Data ValidateRefData
        ...
        private void BGWorkerSearchData_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            MyCommand.Connection = _PMSConnectionString;
            ...
            {
                const String ErrorMessage = "امكان جستجوی اطلاعات مراجعات از بانك وجود ندارد.\n" +
        ...
        private void BGWorkerSearchData_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            for (Int16 i = 0; i < dgvRefData.Rows.Count; i++)
            {
                ...
                for (Int32 j = 0; j < _TypePhysician.Count; j++)
                {
                        ...
                        _TypePhysician.ElementAt(j).Key)
                    {
                        ...
                        {
                            //  به علت تعریف نشدن لیست نوع تخصص های پزشكان ، تخصص ها اینجا به صورت دستی اضافه شد
            ...
            // تنظیم شماره ردیف مراجعات
            foreach (DataGridViewRow row in dgvRefData.Rows) row.Cells[ColRefRow.Index].Value = row.Index + 1;
        ...
        {
            if (e.RowIndex >= 0 && e.ColumnIndex != ColCatType.Index)
            {
                //برای تغییر چك باكس به وسیله كلیك بر روی تمام سطح
        ...
        private void dgvRefData_SelectionChanged(object sender, EventArgs e)
        {
            ...
            #region TypeService
            for (Int16 i = 0; i < dgvServiceData.Rows.Count; i++)
                dgvServiceData[ColServInsCatName.Index, i].Value =
                    _ServiceType[Convert.ToInt16(dgvServiceData.Rows[i].Cells[ColServInsCatID.Index].Value)];
            #endregion
        ...
        private Boolean FillBaseData()
        {
            ...
            _InsType.Add(1, "عادی");
            _InsType.Add(2, "خاص");
            _InsType.Add(3, "بیمارستان های واگذار شده");
            ...
            #region ColServiceType
            //پر كردن كد نوع خدمات
            _ServiceType = new Dictionary<Int16, String>();
            _ServiceType.Add(0, "انتخاب نشده");
            _ServiceType.Add(1, "ویزیت");
            _ServiceType.Add(2, "آزمایشگاه");
            _ServiceType.Add(3, "رادیولوژی");
            _ServiceType.Add(4, "سونو گرافی");
            _ServiceType.Add(5, "سی تی اسكن");
            _ServiceType.Add(6, "ام ار ای");
            _ServiceType.Add(7, "پزشكی هسته ای");
            _ServiceType.Add(8, "رادیوتراپی");
            _ServiceType.Add(9, "رادیو متری");
            _ServiceType.Add(10, "گفتار درمانی");
            _ServiceType.Add(11, "آنژیوگرافی");
            _ServiceType.Add(12, "خدمات مكمل بر اقدامات تشخیصی");
            //در صورت تغییر كلید سی تی اسپیرال باید در هنگام نوشتن فایل نیز در تگ اس جی تغییر حاصل شود
            _ServiceType.Add(13, "سی تی اسپیرال");
            _ServiceType.Add(14, "سنجش تراكم استخوان");

            ColCatType.DataSource = _ServiceType.ToList();
            ColCatType.DisplayMember = "Value";
            ColCatType.ValueMember = "Key";
            ColCatType.DataPropertyName = "TypeID";
            #endregion
        ...
        private Boolean GenerateSearchStrings()
        {
            ...
            StringSelect.Append("SELECT [TblRefList].[Ins1IX] AS [InsuranceID] , ");
            ...
            _SelectedService = new Dictionary<Int32, String>();
            foreach (DataGridViewRow Row in dgvCat.Rows)
            {
                if (Row.Cells[1].Value == null || !Convert.ToBoolean(Row.Cells[1].Value)) continue;
                _ServiceIDSelected += Row.Cells[0].Value + ",";
                // چك كردن اینكه حتماً نوع خدمات انتخاب شده باشد
                if (Row.Cells[3].Value == null || (Int16)Row.Cells[3].Value == 0)
                {
                ...
                _SelectedService.Add(Convert.ToInt32(Row.Cells[ColCatID.Index].Value),
                    Row.Cells[ColCatType.Index].Value.ToString());
            }
            #endregion
            ...
            if (cBoxOrder1.Checked)
                SelectWhereString.Append(" ORDER BY [TblRefList].[PrescriptionDate] , [TblRefList].[RegisterDate] ASC;");
            else SelectWhereString.Append(" ORDER BY[TblRefList].[RegisterDate] , [TblRefList].[PrescriptionDate]  ASC;");
            #endregion
        ...
        private DataTable SelectRefServicesFromDb(Int32 RefID)
        {
            ...
            SelectService.Append("(CASE [TblServList].[CategoryIX] ");
            foreach (DataGridViewRow row in dgvCat.Rows)
            {
                if (row.Cells[ColCatSelect.Index].Value == null || !Convert.ToBoolean(row.Cells[ColCatSelect.Index].Value))
                    continue;
                SelectService.Append("WHEN " + row.Cells[ColCatID.Index].Value);
                SelectService.Append(" THEN " + row.Cells[ColCatType.Index].Value + " ");
            }
            SelectService.Append("END) AS [InsCategoryID] , "); // i = 8
            SelectService.Append("[TblServList].[CategoryIX] , "); // i = 9
            SelectService.Append("[TblRefServs].[ReferralIX] , "); // i = 10
            SelectService.Append("[TblRefServs].[ServiceIX] ");  // i = 11
        ...
        private void GenerateInsDataFile()
        {
            ...
            String FilePath = txtSavePath.Text + "\\OP.Txt";
            try
            {
            ...
            {
                const String ErrorMessage = "امكان ذخیره اطلاعات در فایل انتخاب شده وجود ندارد.\n" +
                    "موارد زیر را بررسی نمایید:\n" +
            ...
            #region <RT> - Unit Type Code
            // كد نوع مركز<RT>
            GeneratedDataString.Append("<RT>");
            GeneratedDataString.Append(txtUnitTypeCode.Text.Trim());
            GeneratedDataString.AppendLine("</RT>");
            #endregion
            ...
            for (Int16 RefRowIndex = 0; RefRowIndex < dgvRefData.Rows.Count; RefRowIndex++)
            {
                ...
                DataRow[] CurrentRefServicesList =
                    _ServiceTable.Select("ReferralIX = " + Convert.ToInt32(dgvRefData[ColRefID.Index, RefRowIndex].Value));
                ...
                GeneratedDataString.Append(dgvRefData[ColRefRow.Index, RefRowIndex].Value);
                GeneratedDataString.Append("</SQ>");
                #endregion
                ...
                #region VD - Ref Ins ValidateRefData Date
                ...
                #region PT - Ins Type - Fix: 103
                // نوع بیمه - مقدار ثابت
                GeneratedDataString.Append("<PT>");
                GeneratedDataString.Append(103);
                GeneratedDataString.Append("</PT>");
                #endregion
                ...
                #region SS - National Code :  Ins1 Number 2
                // Note: از جای دقیق این تگ اطلاعی در دست نیست
                // شماره ملی بیمه شده
                //GeneratedDataString.Append("<SS>");
                //GeneratedDataString.Append(dgvRefData[ColNationalCode.Index, RefRowIndex].Value);
                //GeneratedDataString.Append("</SS>");
                #endregion

                #region CK - Ins Type
                // نوع دفترچه یا صندوق - عادی یا خاص
                GeneratedDataString.Append("<CK>");
                GeneratedDataString.Append(dgvRefData[ColRefIns1TypeID.Index, RefRowIndex].Value);
                GeneratedDataString.Append("</CK>");
                #endregion
                ...
                #region PG - Ref Physician Type ID
                // گروه پزشك بر اساس تعاریف سازمان بیمه
                GeneratedDataString.Append("<PG>");
                GeneratedDataString.Append(dgvRefData[ColRefPhysTypeID.Index, RefRowIndex].Value);
                GeneratedDataString.Append("</PG>");
                #endregion

                #region SG - Services Category ID
                // کد نوع خدمات مراجعه
                // این تگ بر اساس نوع خدمت انتخاب شده برای اولین خدمت مراجعه تعریف می گردد
                // بنابر این یك مراجعه نباید خدماتی از نوع های مختلف داشته باشد
                Int32 FirstServiceCatID = Convert.ToInt32(CurrentRefServicesList[0][9]);
                String SGValue;
                _SelectedService.TryGetValue(FirstServiceCatID, out SGValue);
                if (SGValue == "13") SGValue = "5";
                if (SGValue.Length == 1) SGValue = "0" + SGValue;
                GeneratedDataString.Append("<SG>");
                GeneratedDataString.Append(SGValue);
                GeneratedDataString.Append("</SG>");
                #endregion
                ...
                foreach (DataRow row in CurrentRefServicesList) RefTotalInsPrice += Convert.ToInt32(row["Ins1Price"]);
                ...
                foreach (DataRow row in CurrentRefServicesList)
                    RefTotalPatPartPrice += Convert.ToInt32(row["Ins1PatientPrice"]);
                ...
                foreach (DataRow row in CurrentRefServicesList)
                    RefTotalInsPartPrice += Convert.ToInt32(row["Ins1PartPrice"]);
                GeneratedDataString.Append("<IS>");
                GeneratedDataString.Append(RefTotalInsPartPrice.ToString());
                GeneratedDataString.AppendLine("</IS>");
                #endregion
                ...
                for (Int16 RefServiceIndex = 0; RefServiceIndex < CurrentRefServicesList.Length; RefServiceIndex++)
                {
                    ...
                    #region MG - Internation Code
                    // كد بین المللی - كد هفت رقمی خدمات
                    String InterCode;
                    _ServInternationalCode.TryGetValue(
                        Convert.ToInt16(CurrentRefServicesList[RefServiceIndex][11]), out InterCode);
                    ...
                    #region MN - Service  Description
                    //ToDo: از جای این تگ اطمینان نیست
                    //شرح خدمت كه برای سی تی اسكن اسپیرال S=1
                    GeneratedDataString.Append("<MN>");
                    String x = CurrentRefServicesList[RefServiceIndex][2].ToString();
                    if (Convert.ToInt16(CurrentRefServicesList[RefServiceIndex][8]) == 11) x = "S=1";
                    GeneratedDataString.Append(x);
                    GeneratedDataString.Append("</MN>");
                    #endregion
        ...
        private void SaveSearchSettingsToFile()
        {
            ...
            foreach (DataGridViewRow Row in dgvIns.Rows)
                if (Row.Cells[ColInsSelect.Index].Value != null && Convert.ToBoolean(Row.Cells[ColInsSelect.Index].Value))
                    _SettingDataTable2.Rows.Add(Row.Cells[ColInsID.Index].Value, Row.Cells[ColInsType.Index].Value);
            ...
            foreach (DataGridViewRow Row in dgvCat.Rows)
                if (Row.Cells[ColCatSelect.Index].Value != null && Convert.ToBoolean(Row.Cells[ColCatSelect.Index].Value))
                    _SettingDataTable3.Rows.Add(Row.Cells[ColCatID.Index].Value, Row.Cells[ColCatType.Index].Value);
        ...
        {
            /// <summary>
            /// تابعی برای اصلاح تاریخ برای فرمت YYYY/MM/DD
            /// </summary>
            ...
            public static String DisketDateTimeMaker(DateTime NotFormatedDateTime)
            {
                ...
                String _DisketDT = PDate.Year + A1 + PDate.Month + A2 + PDate.Day;
                return _DisketDT;
            }
        }
        #endregion
