...
namespace Sepehr.Forms
{
    ...
    internal partial class frmManagePhysSpecs : Office2007Form
    {
        ...
        {
            List<SP_SelectRefPhysiciansSpecsResult> Data = Negar.DBLayerPMS.ClinicData.RefPhysicianSpecsList;
            if (Data == null) return false;
            Data = Data.Where(MyData => MyData.ID != null).ToList();
            if (Data.Count == 0)
            {
        ...
        private Boolean SaveDataToFile()
        {
            ...
            {
                const String ErrorMessage = "نوشتن اطلاعات انتخاب شده در فایل ممكن نیست.\n" +
                    "موارد زیر را بررسی نمایید:\n" +
