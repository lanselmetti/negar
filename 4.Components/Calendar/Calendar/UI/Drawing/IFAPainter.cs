...
namespace Negar.PersianCalendar.UI.Drawing
{
    ...
    public interface IFAPainter
    {
        ...
        void DrawFilledBackground(Graphics g, Rectangle rectangle, Boolean isGradient, float angle);
        ...
        /// <param name="isGradient">Specifies if the background should be painted in gradient mode or just filled with a color.</param>
        /// <param name="angle">Angle of the gradient, if the background should be painted in gradient mode.</param>
        void DrawWhiteBackground(Graphics g, Rectangle r, Boolean isGradient, float angle);
        ...
        void DrawButton(Graphics g, Rectangle rectangle, String text, Font font, StringFormat fmt, ItemState state,
                        Boolean hasBorder, Boolean enabled);
        ...
        void DrawBorder(Graphics g, Rectangle rectangle, Boolean enabled);

        /// <summary>
        /// When implemented by a class, Draws the seperator used in <see cref="PersianMonthView"/> control.
        /// </summary>
        /// <param name="g">Instance of the <see cref="System.Drawing.Graphics"/> class.</param>
        ...
        /// <returns></returns>
        Rectangle DrawArrow(Graphics g, Rectangle rc, Boolean isLeft, Boolean isDisabled, Int32 arrowSize);
        ...
        /// <param name="arrowSize">Specifies arrow size.</param>   
        /// <returns></returns>
        Rectangle DrawVerticalArrow(Graphics g, Rectangle rc, Boolean isLeft, Boolean isDisabled, Int32 arrowSize);
        ...
        /// <param name="state">Instance of the ItemState class that specifies content rectangle.</param>
