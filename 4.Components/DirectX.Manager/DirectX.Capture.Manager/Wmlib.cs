...
// interfaces that are needed for the Negar.DirectX.Capture.Manager class example.
namespace Negar.DirectX.Capture.Manager
{
    ...
    public sealed class WMLib
    {
        ...
        public static extern Int32 WMCreateProfileManager(out IWMProfileManager ppProfileManager);
    }
    #endregion
    ...
    public struct WriterStatistics
    {
        ...
        /// <summary> </summary>
        public Int32 dwCurrentBitrate;

        /// <summary> </summary>
        public Int32 dwAverageBitrate;

        /// <summary> </summary>
        public Int32 dwExpectedBitrate;

        /// <summary> </summary>
        public Int32 dwCurrentSampleRate;

        /// <summary> </summary>
        public Int32 dwAverageSampleRate;

        /// <summary> </summary>
        public Int32 dwExpectedSampleRate;
    }
    ...
    public interface IConfigAsfWriter
    {
        /// Obsolete?
        [PreserveSig]
        Int32 ConfigureFilterUsingProfileId([In] Int32 dwProfileId);

        /// Obsolete?
        [PreserveSig]
        Int32 GetCurrentProfileId([Out] out Int32 pdwProfileId);
        ...
        /// <returns></returns>
        [PreserveSig]
        Int32 ConfigureFilterUsingProfileGuid([In, MarshalAs(UnmanagedType.LPStruct)] Guid guidProfile);
        ...
        /// <returns></returns>
        [PreserveSig]
        Int32 GetCurrentProfileGuid([Out] out Guid pProfileGuid);
        ...
        /// <returns></returns>
        [PreserveSig]
        Int32 ConfigureFilterUsingProfile([In] IWMProfile pProfile);
        ...
        /// <returns></returns>
        [PreserveSig]
        Int32 GetCurrentProfile([Out] out IWMProfile ppProfile);
        ...
        /// <returns></returns>
        [PreserveSig]
        Int32 SetIndexMode([In, MarshalAs(UnmanagedType.Bool)] bool bIndexFile);
        ...
        /// <returns></returns>
        [PreserveSig]
        Int32 GetIndexMode([Out, MarshalAs(UnmanagedType.Bool)] out bool pbIndexFile);
    }
    ...
    public interface IWMProfileManager
    {
        ...
        [PreserveSig]
        Int32 GetSystemProfileCount(
            out Int32 pcProfiles
            );

        /// <summary> Load system profile </summary>
        [PreserveSig]
        Int32 LoadSystemProfile(
            [In] Int32 dwProfileIndex,
            out IWMProfile ppProfile
            );
    }
    ...
    public interface IWMProfileManager2 : IWMProfileManager
    {
        ...
        /// <summary> Get system profile count </summary>
        [PreserveSig]
        new Int32 GetSystemProfileCount(
            out Int32 pcProfiles
            );

        /// <summary> Load system profile </summary>
        [PreserveSig]
        new Int32 LoadSystemProfile(
            [In] Int32 dwProfileIndex,
            out IWMProfile ppProfile
            );
    ...
    public interface IWMProfileManagerLanguage
    {
        ...
        [PreserveSig]
        Int32 GetUserLanguageID(
            out short wLangID
            );

        /// <summary> Set user language ID </summary>
        [PreserveSig]
        Int32 SetUserLanguageID(
            short wLangID
            );
    }
    ...
    public interface IWMStreamConfig
    {
        ...
        [PreserveSig]
        Int32 GetBufferWindow(
            out Int32 pmsBufferWindow
            );

        /// <summary> Set buffer window </summary>
        [PreserveSig]
        Int32 SetBufferWindow(
            [In] Int32 msBufferWindow
            );
    }
    ...
    public interface IWMProfile
    {
        ...
        Int32 GetDescription(
            ...
            ref Int32 pcchDescription
            );

        /// <summary> Set description </summary>
        [PreserveSig]
        Int32 SetDescription(
        ...
        [PreserveSig]
        Int32 ReconfigStream(
            [In] IWMStreamConfig pConfig
            );

        /// <summary> Create new stream </summary>
        [PreserveSig]
        Int32 CreateNewStream(
        ...
        [PreserveSig]
        Int32 GetMutualExclusionCount(
            out Int32 pcME
            );

        /// <summary> Get mutual exclusion </summary>
        [PreserveSig]
        Int32 GetMutualExclusion(
            [In] Int32 dwMEIndex,
    ...
    public interface IWMProfile2 : IWMProfile
    {
        ...
        /// <summary>  </summary>
        [PreserveSig]
        new Int32 SetDescription(
            [In] string pwszDescription
            );

        /// <summary>  </summary>
        [PreserveSig]
        new Int32 GetStreamCount(
            out Int32 pcStreams
            );
        ...
        /// <summary>  </summary>
        [PreserveSig]
        new Int32 RemoveStream(
            [In] IWMStreamConfig pConfig
            );

        /// <summary>  </summary>
        [PreserveSig]
        new Int32 RemoveStreamByNumber(
            [In] short wStreamNum
            );
        ...
        /// <summary>  </summary>
        [PreserveSig]
        new Int32 ReconfigStream(
            [In] IWMStreamConfig pConfig
            );

        /// <summary>  </summary>
        [PreserveSig]
        new Int32 CreateNewStream(
            [In, MarshalAs(UnmanagedType.LPStruct)] Guid guidStreamType,
            out IWMStreamConfig ppConfig
            );
        ...
        /// <summary>  </summary>
        [PreserveSig]
        new Int32 GetMutualExclusionCount(
            out Int32 pcME
            );

        /// <summary>  </summary>
        [PreserveSig]
        new Int32 GetMutualExclusion(
            [In] Int32 dwMEIndex,
            out IWMMutualExclusion ppME
            );
        ...
        /// <summary>  </summary>
        [PreserveSig]
        new Int32 RemoveMutualExclusion(
            [In] IWMMutualExclusion pME
            );

        /// <summary>  </summary>
        [PreserveSig]
        new Int32 AddMutualExclusion(
            [In] IWMMutualExclusion pME
            );

        /// <summary>  </summary>
        [PreserveSig]
        new Int32 CreateNewMutualExclusion(
            out IWMMutualExclusion ppME
            );
    ...
    #region public sealed class WMData
    /// <summary>
    ...
    public sealed class WMData
    {
        ...
        private static readonly Guid WMProfile_V40_56DialUpVideoWebServer =
            new Guid("b756ff10-520f-4749-a399-b780e2fc9250");
        ...
        private static readonly Guid WMProfile_V70_1500FilmContentVideo =
            new Guid("F6A5F6DF-EE3F-434c-A433-523CE55F516B");
        ...
        public static readonly Guid WMProfile_V80_56VideoOnly = new Guid(0x6E2A6955, 0x81DF, 0x4943, 0xBA, 0x50, 0x68,
                                                                         0xA9, 0x86, 0xA7, 0x08, 0xF6);
