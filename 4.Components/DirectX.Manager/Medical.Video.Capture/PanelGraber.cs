...
{
    /// <summary>
    /// فرم ثبت تصاویر از ابزار ویدئویی
    /// </summary>
    internal partial class frmPanelGraber : Form
    {
        ...
        #region Ctor
        public frmPanelGraber(Int32 RefID)
        {
            InitializeComponent();
        ...
        void btnVideoDevice_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    _CaptureObject = new Capture(CurrentVideoDevice, null, false);
        ...
        private Boolean InitializeVideoDevices()
        {
            try
            {
                _Filters = new Filters(false, true);
