...
namespace Scsi.Multimedia
{
    ...
    public class DvdContentScramblingSystemFeature : MultimediaFeature
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)] private byte _ContentScramblingSystemVersion;

        [DisplayName("Content Scrambling System Version")]
        public byte ContentScramblingSystemVersion
        {
            get { return _ContentScramblingSystemVersion; }
            set { _ContentScramblingSystemVersion = value; }
        }
    }
}