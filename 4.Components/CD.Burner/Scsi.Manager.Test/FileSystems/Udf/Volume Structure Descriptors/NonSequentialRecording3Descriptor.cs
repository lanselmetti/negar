...
namespace FileSystems.Udf
{
	...
	public class NonSequentialRecording3Descriptor : UdfVolumeStructureDescriptor
	{
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private static readonly IntPtr RESERVED1_BP = (IntPtr)7; //Marshal.OffsetOf(typeof(NonSequentialRecording3Descriptor), "_Reserved1");
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private static readonly IntPtr STRUCTURE_DATA_BP = (IntPtr)8; //Marshal.OffsetOf(typeof(NonSequentialRecording3Descriptor), "_StructureData");

		public NonSequentialRecording3Descriptor() : base("NSR03", 1) { }
		...
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		protected override int MarshaledSize { get { return Marshaler.DefaultSizeOf<NonSequentialRecording3Descriptor>(); } }
	}
}