...
IF  EXISTS (SELECT * FROM [sys].[triggers] 
	WHERE OBJECT_ID = OBJECT_ID(N'Accounting.TR_AfterRefCostsAndDiscountsChanged'))
	DROP TRIGGER [Accounting].[TR_AfterRefCostsAndDiscountsChanged];
GO
-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
CREATE TRIGGER [TR_AfterRefCostsAndDiscountsChanged]
ON [ImagingSystem].[Accounting].[RefCostsAndDiscounts]
WITH ENCRYPTION
