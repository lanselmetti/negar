...
using Negar.Customers.Reports0001;

namespace Negar.Customers.StartReports0001
{
    /// <summary>
    ...
    public static class ReportStartClass
    {
        ...
        #region Fields
        private const String _ReportName = "گزارش حسابداری";
        private const String _CustomerName = "مركز تصویربرداری سهند قزوین";
        private const String _ReleaseDate = "89/06/09";
        private const String _Version = "4";
