...
namespace Sepehr.Settings.Services
{
    ...
    public partial class frmGroups : Form
    {
        ...
        #region IQueryable<ServicesGroups> _DataSource
        /// <summary>
        /// فیلد منبع اطلاعاتی فرم
        /// </summary>
        private IQueryable<ServicesGroups> _DataSource;
        #endregion
        ...
        //بررسی تكراری بودن نام گروه وارد شده
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            DialogResult Dr = PMBox.Show("آیا مایلید گروه زیر حذف گردد:\n\"" +
                dgvData.Rows[RowIndex].Cells[1].Value +
                "\"\nبا حذف این گروه ، عضویت كلیه خدماتی كه در این گروه ثبت شده اند حذف خواهد شد.",
            ...
            if (Dr == DialogResult.Yes)
                ...
                catch (Exception Ex)
                {
                    const String ErrorMessage =
                        "امكان حذف گروه از بانك وجود ندارد.\n" +
        ...
        private void SetControlsToolTipTexts()
        {
            ...
            String TooltipText = ToolTipManager.GetText("cBoxWithInActivesServicesGroups", "IMS");
            ...
            #region btnAdd
            TooltipText = ToolTipManager.GetText("btnAddServicesGroups", "IMS");
        ...
        {
            try { _DataSource = DBLayerIMS.Manager.DBML.ServicesGroups.OrderBy(Group => Group.Name); }
            #region Catch
            catch (Exception Ex)
            {
                const String ErrorMessage =
                    "امكان خواندن اطلاعات گروه های خدمات از بانك وجود ندارد.\n" +
                    "موارد زیر را بررسی نمایید:\n" +
                    "1. آیا ارتباط شما با بانك اطلاعات برقرار است و شبكه متصل می باشد؟";
                PMBox.Show(ErrorMessage, "خطا!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                LogManager.SaveLogEntry("Sepehr", "Services Settings", Ex.Message + "\n" + Ex.StackTrace, EventLogEntryType.Error);
