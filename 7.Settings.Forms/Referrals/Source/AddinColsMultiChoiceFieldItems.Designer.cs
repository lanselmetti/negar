namespace Sepehr.Settings.Referrals
{
    partial class frmAddinColsMultiChoiceFieldItems
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnAdd.Image = global::Sepehr.Settings.Referrals.Properties.Resources.LeftLarge;
            ...
            this.Text = "تنظیمات - مراجعات - فیلد های پویا - انتخاب آیتم های قابل استفاده برای یك فیلد چند" +
                " گزینه ای";
