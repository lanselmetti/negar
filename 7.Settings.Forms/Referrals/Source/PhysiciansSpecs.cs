...
{
    /// <summary>
    /// فرم مدیریت تخصص های پزشكان مراجعه
    /// </summary>
    public partial class frmPhysiciansSpecs : Form
    {

        #region Fields

        #region IQueryable<RefPhysiciansSpec> _DataSource
        /// <summary>
        /// فیلد منبع اطلاعاتی فرم
        /// </summary>
        private IQueryable<RefPhysiciansSpec> _DataSource;
        #endregion
        ...
        void dgvData_DefaultValuesNeeded(object sender, DataGridViewRowEventArgs e)
        {
            ...
            e.Row.Cells[1].Value = "عنوان تخصص";
        }
        #endregion
        ...
        private void cBoxWithInActives_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                DialogResult Dr = PMBox.
                    Show("در صورتی كه ردیفی را حذف كرده باشید باید قبل از تغییر وضعیت نمایش فرم ، " +
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            DialogResult Dr = PMBox.Show("آیا مایلید ردیف زیر حذف گردد:\n\"" +
                ...
                "\"\nبا حذف این تخصص ، تخصص كلیه پزشكان مراجعه ای كه این تخصص برای آنها ثبت شده حذف خواهد شد.",
            ...
            if (Dr == DialogResult.Yes)
                ...
                catch (Exception Ex)
                {
                    const String ErrorMessage =
                        "امكان حذف تخصص از بانك وجود ندارد.\n" +
        ...
        private void Form_Closing(object sender, FormClosingEventArgs e)
        {
            ...
            if (_IsGridValuesChanged)
            {
                DialogResult Dr = PMBox.Show("آیا از اعمال تغییرات منصرف شدید؟", "پرسش؟", MessageBoxButtons.YesNo,
                    MessageBoxIcon.Question, MessageBoxDefaultButton.Button2);
        ...
        private void SetControlsToolTipTexts()
        {
            ...
            TooltipText = ToolTipManager.GetText("cBoxWithInActivesRefPhysSpecs", "IMS");
            ...
            #region btnAdd
            TooltipText = ToolTipManager.GetText("btnAddRefPhysSpecs", "IMS");
        ...
        private Boolean FillDataSource()
        {
            try
            {
                _DataSource = Negar.DBLayerPMS.Manager.DBML.RefPhysiciansSpecs.
                    OrderBy(RefPhysiciansSpec => RefPhysiciansSpec.Title);
            }
            #region Catch
            catch (Exception Ex)
            {
                const String ErrorMessage =
                    "امكان خواندن اطلاعات تخصص پزشكان از بانك وجود ندارد.\n" +
                    "موارد زیر را بررسی نمایید:\n" +
                    "1. آیا ارتباط شما با بانك اطلاعات برقرار است و شبكه متصل می باشد؟";
