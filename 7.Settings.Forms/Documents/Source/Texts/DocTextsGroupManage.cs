...
{
    /// <summary>
    /// فرم مدیریت گروه های متن مدارك تصویربرداری
    /// </summary>
    internal partial class frmDocTextsGroupManage : Form
    {

        #region Ctors

        #region public frmDocTextsGroupManage()
        /// <summary>
        /// سازنده پیش فرض فرم در حالت افزودن
        /// </summary>
        public frmDocTextsGroupManage()
        {
        ...
        #region public frmDocTextsGroupManage(Int16 ColID)
        /// <summary>
        /// سازنده پیش فرض فرم در حالت ویرایش
        /// </summary>
        public frmDocTextsGroupManage(Int16 ColID)
        {
            Application.CurrentInputLanguage = InputLanguage.FromCulture(new System.Globalization.CultureInfo("Fa-Ir"));
            InitializeComponent();
        ...
        /// </summary>
        /// <param name="ColID">كلید گروه</param>
        /// <returns>ٌصحت انجام كار</returns>
        private Boolean FillColData(Int16 ColID)
        {
            try
            {
                DocText ColData = DBLayerIMS.Manager.DBML.DocTexts.Where(Data => Data.ID == ColID).ToList().First();
            ...
            catch (Exception Ex)
            {
                const String ErrorMessage =
                    "امكان خواندن اطلاعات گروه های متن مدارك تصویربرداری انتخاب شده از بانك وجود ندارد.\n" +
