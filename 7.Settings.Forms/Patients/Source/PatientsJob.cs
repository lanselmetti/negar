...
{
    /// <summary>
    /// فرم مدیریت مشاغل بیماران
    /// </summary>
    public partial class frmPatientsJob : Form
    {

        #region Fields

        #region IQueryable<PatJob> _DataSource
        /// <summary>
        /// فیلد منبع اطلاعاتی فرم
        /// </summary>
        private IQueryable<PatJob> _DataSource;
        #endregion
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            DialogResult Dr = PMBox.Show("آیا مایلید شغل زیر حذف گردد:\n\"" +
                dgvData.Rows[RowIndex].Cells[1].Value +
                "\"\nبا حذف این شغل ، اطلاعات شغل كلیه بیمارانی كه این شغل برای آنها ثبت شده حذف خواهد شد.", "هشدار!",
            ...
            if (Dr == DialogResult.Yes)
                ...
                catch (Exception Ex)
                {
                    const String ErrorMessage =
                        "امكان حذف شغل از بانك وجود ندارد.\n" +
        ...
        private void Form_Closing(object sender, FormClosingEventArgs e)
        {
            ...
            if (_IsGridValuesChanged)
            {
                DialogResult Dr = PMBox.Show("آیا از اعمال تغییرات منصرف شدید؟", "پرسش؟",
                    MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2);
        ...
        private void SetControlsToolTipTexts()
        {
            ...
            TooltipText = ToolTipManager.GetText("cBoxWithInActivesPatJobs", "IMS");
            ...
            #region btnAdd
            TooltipText = ToolTipManager.GetText("btnAddPatJob", "IMS");
        ...
        /// <summary>
        /// تابع خواندن اطلاعات جدول مشاغل از بانك
        /// </summary>
        private Boolean FillDataSource()
        {
            try { _DataSource = Negar.DBLayerPMS.Manager.DBML.PatJobs.OrderBy(Job => Job.Title); }
            #region Catch
            catch (Exception Ex)
            {
                const String ErrorMessage = "امكان خواندن اطلاعات مشاغل از بانك وجود ندارد.\n" +
                    "موارد زیر را بررسی نمایید:\n" +
                    "1. آیا ارتباط شما با بانك اطلاعات برقرار است و شبكه متصل می باشد؟";
                PMBox.Show(ErrorMessage, "خطا!", MessageBoxButtons.OK, MessageBoxIcon.Error);
