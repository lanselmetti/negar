...
{
    /// <summary>
    /// فرم مدیریت تنظیمات كشورهای بیماران
    /// </summary>
    public partial class frmCountries : Form
    {
        ...
        #region IQueryable<Country> _DataSource
        /// <summary>
        /// فیلد منبع اطلاعاتی فرم
        /// </summary>
        private IQueryable<Country> _DataSource;
        #endregion
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            DialogResult Dr = PMBox.Show("آیا مایلید كشور زیر حذف گردد:\n\"" +
                dgvData.Rows[RowIndex].Cells[1].Value +
                "\"\nبا حذف این كشور ، اطلاعات شهر ، استان و كشور كلیه بیمارانی كه این كشور برای آنها ثبت شده حذف خواهد شد.",
        ...
        private void SetControlsToolTipTexts()
        {
            ...
            TooltipText = ToolTipManager.GetText("cBoxWithInActivesPatCountries", "IMS");
            ...
            #region btnAdd
            TooltipText = ToolTipManager.GetText("btnAddPatCountries", "IMS");
        ...
        /// <summary>
        /// تابع خواندن اطلاعات جدول  كشورها از بانك
        /// </summary>
        private Boolean FillDataSource()
        {
            try { _DataSource = Negar.DBLayerPMS.Manager.DBML.Countries.OrderBy(Country => Country.Name); }
            #region Catch
            catch (Exception Ex)
            {
                const String ErrorMessage =
                    "امكان خواندن اطلاعات كشورها از بانك وجود ندارد.\n" +
                    "موارد زیر را بررسی نمایید:\n" +
