...
{
    /// <summary>
    /// فرم مدیریت فیلد اطلاعات اضافی بیماران
    /// </summary>
    internal partial class frmAdditionalColsManage : Form
    {
        ...
        #region PatAdditionalColumn _CurrentFieldData
        /// <summary>
        /// فیلد اطلاعات ستون پویا جاری برای ویرایش
        /// </summary>
        private PatAdditionalColumn _CurrentFieldData;
        #endregion
        ...
        #region frmAdditionalColsManage()
        /// <summary>
        /// سازنده پیش فرض فرم
        /// </summary>
        public frmAdditionalColsManage()
        {
        ...
        #region frmAdditionalColsManage(Int16 ColID)
        /// <summary>
        /// سازنده پیش فرض فرم
        /// </summary>
        public frmAdditionalColsManage(Int16 ColID)
        {
            Application.CurrentInputLanguage = InputLanguage.FromCulture(new System.Globalization.CultureInfo("Fa-Ir"));
            InitializeComponent();
            _IsAdding = false;
        ...
        private Boolean FillCurrentColData()
        {
            ...
            DBLayerIMS.Referrals.PatAddinColsList = null;
            List<PatAdditionalColumn> FieldData = DBLayerIMS.Referrals.PatAddinColsList;
        ...
        public static Boolean InsertAddinColumn(String FieldName, Byte TypeID, Byte? FieldLenght, String Description)
        {
            try
            {
                DBLayerIMS.Manager.DBML.SP_InsertPatAdditionalColumns(FieldName.Trim().Normalize(),
            ...
            catch (Exception Ex)
            {
                ...
                LogManager.SaveLogEntry("Sepehr", "Settings - Patients", Ex.Message + "\n" + Ex.StackTrace, EventLogEntryType.Error);
                return false;
            }
            #endregion
            return true;
