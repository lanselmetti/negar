...
{
    /// <summary>
    /// فرم مدیریت اندام برای ارتباط با پكس                                                                                                     
    /// </summary>
    public partial class frmStudies: Form
    {
        ...
        private Table<Study> _DataSource;
        #endregion
        ...
        {
            e.Row.Cells[0].Value = "Study Name";
        }
        #endregion
        ...
        {
            try { _DataSource = DBLayerIMS.Manager.DBML.Studies; }
            #region Catch
            catch (Exception Ex)
            {
