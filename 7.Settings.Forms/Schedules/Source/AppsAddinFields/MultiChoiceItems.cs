...
{
    /// <summary>
    /// فرم مدیریت آیتم های ستون های چند گزینه ای برای ستون های پویا نوبت دهی
    /// </summary>
    internal partial class frmAddinColsMultiChoiceItems : Form
    {
        ...
        {
            try { dgvData.DataSource = DBLayerIMS.Manager.DBML.SchAddinDataItems; }
            #region Catch
            catch (Exception Ex)
            {
