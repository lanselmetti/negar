namespace Sepehr.Settings.Schedules.AppsAddinFields
{
    partial class frmAddinColsMultiChoiceFieldItems
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnAdd.Image = global::Sepehr.Settings.Schedules.Properties.Resources.LeftLarge;
            ...
            this.Text = "تنظیمات - نوبت دهی - فیلد های پویا - انتخاب آیتم های قابل استفاده برای یك فیلد چن" +
                "د گزینه ای";
