...
namespace Negar.Classes
{
    ...
    public class ShellLink : IDisposable
    {
        ...
        {
            NormalWindow = EShowWindowFlags.SW_NORMAL,
            MinimizedWindow = EShowWindowFlags.SW_SHOWMINNOACTIVE,
            MaximizedWindow = EShowWindowFlags.SW_MAXIMIZE
        }
