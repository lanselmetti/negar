...
using Negar.BarcodeManager.Symbologies;
#endregion
...
namespace Negar.BarcodeManager
{
    ...
    public enum TYPE : int
    {
        ...
        EAN13, EAN8, Interleaved2of5, Standard2of5, Industrial2of5, CODE39, CODE39Extended, Codabar, PostNet,
        BOOKLAND, ISBN, JAN13, MSI_Mod10, MSI_2Mod10, MSI_Mod11, MSI_Mod11_Mod10, Modified_Plessey,
        CODE11, USD8, UCC12, UCC13, LOGMARS, CODE128, CODE128A, CODE128B, CODE128C, ITF14, CODE93, TELEPEN, FIM
    };
    #endregion

    #region SaveTypes : int
    public enum SaveTypes : int
    {
        JPG, BMP, PNG, GIF, TIFF, UNSPECIFIED
    };
    #endregion

    #region AlignmentPositions : int
    ...
    public class Barcode : IDisposable
    {
        ...
        #region string Country_Assigning_Manufacturer_Code
        /// <summary>
        ...
        #region LabelPositions LabelPosition
        /// <summary>
        ...
        #region RotateFlipType RotateFlipType
        /// <summary>
        ...
        #region ImageFormat ImageFormat
        /// <summary>
        ...
        #region AlignmentPositions Alignment
        /// <summary>
        ...
        #region Barcode(string data, TYPE iType)
        /// <summary>
        /// 
        /// </summary>
        ...
        #region Image Encode(TYPE iType, string StringToEncode, int Width, int Height)
        /// <summary>
        ...
        #region Image Encode(TYPE iType, string StringToEncode, Color ForeColor, Color BackColor, int Width, int Height)
        /// <summary>
        /// Encodes the raw data into binary form representing bars and spaces.  Also generates an Image of the barcode.
        /// </summary>
        /// <param name="iType">Type of encoding to use.</param>
        ...
        #region Image Encode(TYPE iType, string StringToEncode, Color ForeColor, Color BackColor)
        /// <summary>
        /// Encodes the raw data into binary form representing bars and spaces.  Also generates an Image of the barcode.
        /// </summary>
        /// <param name="iType">Type of encoding to use.</param>
        ...
        #region Image Encode(TYPE iType, string StringToEncode)
        /// <summary>
        /// Encodes the raw data into binary form representing bars and spaces.  Also generates an Image of the barcode.
        /// </summary>
        /// <param name="iType">Type of encoding to use.</param>
        ...
        #region Image Encode(TYPE iType)
        /// <summary>
        /// Encodes the raw data into binary form representing bars and spaces.  Also generates an Image of the barcode.
        /// </summary>
        /// <param name="iType">Type of encoding to use.</param>
                            ...
                            using (Pen pen = new Pen(ForeColor, iBarWidth))
                            {
                                ...
                                while (pos < Encoded_Value.Length)
                                {
                                    ...
                                    if (Encoded_Value[pos] == '1')
                                        g.DrawLine(pen, new Point((pos * iBarWidth) + shiftAdjustment + bearerwidth + iquietzone, 0), 
        ...
        #region Byte[] GetImageData(SaveTypes savetype)
        /// <summary>
        ...
        #region void SaveImage(string Filename, SaveTypes FileType)
        /// <summary>
        ...
        #region void SaveImage(Stream stream, SaveTypes FileType)
        /// <summary>
        ...
        #region void GetSizeOfImage(ref double Width, ref double Height, bool Metric)
        /// <summary>
        ...
        #region Image Label_ITF14(Image img)
        /// <summary>
        /// 
        /// </summary>
        ...
        #region Image Label_Generic(Image img)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="img"></param>
            ...
            try
            {
                ...
                using (Graphics g = Graphics.FromImage(img))
                {
                    ...
                    g.FillRectangle(new SolidBrush(this.BackColor), 
                        new RectangleF((float)0, (float)LabelY, (float)img.Width, (float)font.Height));

                    //draw datastring under the barcode image
                    g.DrawString(this.RawData, font, new SolidBrush(this.ForeColor), 
                        new RectangleF((float)0, (float)LabelY, (float)img.Width, (float)font.Height), f);
        ...
        #region Image Label_UPCA(Image img)
        /// <summary>
        ...
        #region static Boolean CheckNumericOnly(string Data)
        /// <summary>
        /// 
        /// </summary>
        /// <param name="Data"></param>
        /// <returns></returns>
        internal static Boolean CheckNumericOnly(string Data)
        {
        ...
        #region static Image GetImageFromXML(BarcodeXML internalXML)
        /// <summary>
        /// 
        /// </summary>
        ...
        #region static Image DoEncode(TYPE iType, string Data)
        /// <summary>
        /// Encodes the raw data into binary form representing bars and spaces.  Also generates an Image of the barcode.
        /// </summary>
        /// <param name="iType">Type of encoding to use.</param>
        ...
        #region static Image DoEncode(TYPE iType, string Data, ref string XML)
        /// <summary>
        /// Encodes the raw data into binary form representing bars and spaces.  Also generates an Image of the barcode.
        /// </summary>
        /// <param name="iType">Type of encoding to use.</param>
        ...
        #region static Image DoEncode(TYPE iType, string Data, bool IncludeLabel)
        /// <summary>
        /// Encodes the raw data into binary form representing bars and spaces.  Also generates an Image of the barcode.
        /// </summary>
        /// <param name="iType">Type of encoding to use.</param>
        ...
        #region static Image DoEncode(TYPE iType, string Data, bool IncludeLabel, int Width, int Height)
        /// <summary>
        /// Encodes the raw data into binary form representing bars and spaces.  Also generates an Image of the barcode.
        /// </summary>
        /// <param name="iType">Type of encoding to use.</param>
        ...
        #region static Image DoEncode(TYPE iType, string Data, bool IncludeLabel, Color DrawColor, Color BackColor)
        /// <summary>
        /// Encodes the raw data into binary form representing bars and spaces.  Also generates an Image of the barcode.
        /// </summary>
        /// <param name="iType">Type of encoding to use.</param>
